...
export const selectPlayers = createSelector(selectGame, (game: GameBoardGameState) => game.players);
...
export const selectGamePhase = createSelector(selectGame, (game: GameBoardGameState) => game.stage);
...
export const selectWinnerPlayer = createSelector(
  selectGame,
  (game: GameBoardGameState) => game.players.find((player) => player.id === game.winnerPlayerId),
);
